        ...
        <div className="grid lg:grid-cols-2 gap-12">
          <div>
            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">info@teachfornigeria.org</p>
                  <p className="text-gray-600">apply@teachfornigeria.org</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">+234 (0) 800 TEACH NG</p>
            ...
            <div className="mt-8 p-6 bg-blue-50 rounded-lg border border-blue-200">
              ...
              <p className="text-blue-800">Monday - Friday: 8:00 AM - 6:00 PM</p>
